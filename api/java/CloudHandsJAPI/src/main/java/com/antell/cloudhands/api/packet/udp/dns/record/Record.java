...
import com.antell.cloudhands.api.packet.udp.dns.common.*;
...
public abstract class Record {
    ...
    public abstract void read(DNSDataInput dataInput) throws IOException;
    ...
    public abstract XContentBuilder rdataToJson(XContentBuilder cb) throws IOException;

    public abstract void rdataToJsonString(StringBuffer sb);
