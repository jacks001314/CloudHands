...
static int _get_rxtasks_number(ch_pdump_context_t *pdcontext){
...
static int _create_all_rxtasks(ch_pdump_context_t *pdcontext,ch_packet_rxtask_pool_t *rxtask_pool){
...
ch_packet_rxtask_pool_t * ch_packet_rxtask_pool_create(ch_pdump_context_t *pdcontext){
