...
ch_tcp_session_task_t * ch_tcp_session_task_create(ch_tcp_work_t *tcp_work,uint32_t task_id){
	...
	tcp_session_task->shandler = ch_tcp_session_handler_create(tcp_work->mp,tcp_work->tcp_context,task_id);
	...
	tcp_session_task->sreq_handler = ch_tcp_session_request_handler_create(tcp_work->mp,
																		tcp_work->tcp_context,
																		tcp_work->ta_pool,
																		tcp_session_task->shandler);
