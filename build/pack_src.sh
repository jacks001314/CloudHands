...
cloudhands_bin_name=CloudHands_src_$cloudhands_ver.bin
...
do_pack(){
    ...
    bash ./makeself/makeself.sh --gzip package $cloudhands_bin_name 'build cloudhands ....' ./install_src.sh
