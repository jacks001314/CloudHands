...
ch_udp_session_task_t * ch_udp_session_task_create(ch_udp_work_t *udp_work,uint32_t task_id){
	...
	udp_session_task->udp_session_handler = ch_udp_session_handler_create(udp_work->mp,udp_work->udp_context,task_id,
							udp_session_task->shm_fmt,&udp_session_task->dout,udp_session_task->dstore);
	...
	udp_session_task->udp_session_req_handler = ch_udp_session_request_handler_create(udp_work->mp,udp_work->udp_context,udp_work->app_pool,
									udp_session_task->udp_session_handler,task_id);
